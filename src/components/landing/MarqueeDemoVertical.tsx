...
export function MarqueeDemoVertical() {
  return (
    <div className="relative flex flex-wrap h-[500px] w-full flex-row items-center justify-center overflow-hidden rounded-lg border bg-background md:shadow-xl">
